			...
			<div id="post-body-content">
				...
				<div class="meta-box-sortables">
					<div class="postbox">
						<div class="postbox-header">
							<h2 class="hndle">
								<span><?php _e( 'Need Support & Solutions?', 'wp-responsive-recent-post-slider' ); ?></span>
							</h2>
						</div>
						<div class="inside">
							<table class="form-table">
								<tbody>
									<tr>
										<td>
											<p><?php _e('Boost design and best solution for your website.', 'wp-responsive-recent-post-slider'); ?></p> <br/>										
											<a class="button button-primary button-orange" href="<?php echo WPRPS_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Post-Slider&utm_campaign=Check-Designs-Solutions" target="_blank"><?php _e('Boost Design', 'wp-responsive-recent-post-slider'); ?></a>
										</td>
									</tr>
								</tbody>
							</table>
				...
				<div class="meta-box-sortables">
					<div class="postbox wpos-pro-box">
						...
						<div class="inside">
							...
							<a class="button button-primary wpos-button-full button-orange" href="<?php echo WPRPS_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Post-Slider&utm_campaign=How-It-Work" target="_blank"><?php _e('Go Premium ', 'wp-responsive-recent-post-slider'); ?></a>
							<p><a class="button button-primary wpos-button-full" href="https://demo.essentialplugin.com/prodemo/post-slider-pro/" target="_blank"><?php _e('View PRO Demo ', 'wp-responsive-recent-post-slider'); ?></a></p>
						</div><!-- .inside -->
					</div><!-- #general -->
				</div><!-- .meta-box-sortables -->
